...
st.markdown("<h2 style='text-align: left; font-size: 1.5em; font-style: italic;'>If you prefer to manually sketch your own molecular structures</h2>", unsafe_allow_html=True)
