...
if selected_mode == "QSAR":
    st.sidebar.markdown("In our investigation, the classification of a compound as active or inactive for Fyn kinase was conducted using the XGBoost model. A compound was deemed active if the anticipated IC<sup>50</sup> was below 1 &micro;M, and inactive if the predicted IC<sub>50</sub> equaled or exceeded 1 &micro;M.")
